...
public static class IndexOptimizations
{
    ...
    {
        var customerEntity = modelBuilder.Entity<SMBErp.Models.Customer>();
    ...
    {
        var itemEntity = modelBuilder.Entity<SMBErp.Models.Item>();
        ...
        var productEntity = modelBuilder.Entity<SMBErp.Models.Product>();
        ...
        var serviceEntity = modelBuilder.Entity<SMBErp.Models.Service>();
    ...
    {
        var invoiceEntity = modelBuilder.Entity<SMBErp.Models.Invoice>();
    ...
    {
        var invoiceItemEntity = modelBuilder.Entity<SMBErp.Models.InvoiceItem>();
    ...
    {
        var emailTemplateEntity = modelBuilder.Entity<SMBErp.Models.EmailTemplate>();
