    ...
    private static void SeedCompanyData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Company>().HasData(
            new Company
            {
                ...
                PostalCode = "80331",
                Country = "Österreich",
                Phone = "+43 111 1111111111",
                Email = "info@musterfirma.at",
                Website = "https://www.musterfirma.at",
                VatId = "ATU12345678",
    ...
    private static void SeedCustomers(ModelBuilder modelBuilder)
    {
        var customers = new List<Customer>
        {
            new Customer
            {
                ...
                FirstName = "Anna",
                LastName = "Muster",
                Email = "anna.muster@musterkunde.at",
                Phone = "+43 893 34353445",
            ...
            new Customer
            {
                ...
                FirstName = "Peter",
                LastName = "Privatmann",
                Email = "peter.privatmann@email.at",
                Phone = "+43 30 123456789",
